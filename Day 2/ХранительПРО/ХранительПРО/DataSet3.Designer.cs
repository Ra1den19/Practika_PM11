...
namespace ХранительПРО {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class СотрудникиDataTable : global::System.Data.TypedTableBase<СотрудникиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public СотрудникиRow AddСотрудникиRow(int код_сотрудника, string ФИО, string телефон, string email) {
...
namespace ХранительПРО.DataSet3TableAdapters {
    ...
    public partial class СотрудникиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [ХранительПРО].[dbo].[Сотрудники] WHERE (([код сотрудника] = ?) AND (" +
                "(? = 1 AND [ФИО] IS NULL) OR ([ФИО] = ?)) AND ((? = 1 AND [телефон] IS NULL) OR " +
                "([телефон] = ?)) AND ((? = 1 AND [email] IS NULL) OR ([email] = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [ХранительПРО].[dbo].[Сотрудники] SET [код сотрудника] = ?, [ФИО] = ?, [телефон] = ?, [email] = ? WHERE (([код сотрудника] = ?) AND ((? = 1 AND [ФИО] IS NULL) OR ([ФИО] = ?)) AND ((? = 1 AND [телефон] IS NULL) OR ([телефон] = ?)) AND ((? = 1 AND [email] IS NULL) OR ([email] = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"код сотрудника\", \"ФИО\", \"телефон\", \"email\" FROM \"dbo\".\"Сотрудники\"";
        ...
        public virtual int Fill(DataSet3.СотрудникиDataTable dataTable) {
        ...
        public virtual DataSet3.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet3.СотрудникиDataTable dataTable = new DataSet3.СотрудникиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet3.СотрудникиDataTable dataTable) {
        ...
        public virtual int Delete(int Original_код_сотрудника, string Original_ФИО, string Original_телефон, string Original_email) {
        ...
        public virtual int Insert(int код_сотрудника, string ФИО, string телефон, string email) {
        ...
        public virtual int Update(int код_сотрудника, string ФИО, string телефон, string email, int Original_код_сотрудника, string Original_ФИО, string Original_телефон, string Original_email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string телефон, string email, int Original_код_сотрудника, string Original_ФИО, string Original_телефон, string Original_email) {
            return this.Update(Original_код_сотрудника, ФИО, телефон, email, Original_код_сотрудника, Original_ФИО, Original_телефон, Original_email);
        }
    }
